...
namespace Data2Checker
{
    public partial class MainWindow : Window
    {
        ...
        static SQLMethods QueryMethods = new SQLMethods();
        bool WaitTxt = false;
        ...
        private void StartTimer()
        {
            ...
            DateTime nextExecutionTime = DateTime.Now.AddMinutes(10);
            if (nextExecutionTime < now)
            {
                nextExecutionTime = nextExecutionTime.AddMinutes(2);
            }
        ...
        {
            txtRemainingTime.Text = $"Zeit bis zur nächsten Ausführung: {remainingTime.Hours}h {remainingTime.Minutes}m {remainingTime.Seconds}s";
        }
